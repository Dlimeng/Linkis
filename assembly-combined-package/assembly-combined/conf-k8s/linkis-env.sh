...
ENGINECONN_ROOT_PATH=/opt/linkis/appcom/tmp
...
HIVE_META_URL=$K8S_ENV_HIVE_META_URL
HIVE_META_USER=$K8S_ENV_HIVE_META_USER
HIVE_META_PASSWORD=$K8S_ENV_HIVE_META_PASSWORD

##YARN REST URL  spark engine required
YARN_RESTFUL_URL=$K8S_ENV_YARN_RESTFUL_URL
...
###HADOOP CONF DIR
HADOOP_CONF_DIR=$K8S_ENV_HADOOP_CONF_DIR

###HIVE CONF DIR
HIVE_CONF_DIR=$K8S_ENV_HIVE_CONF_DIR

###SPARK CONF DIR
SPARK_CONF_DIR=$K8S_ENV_SPARK_CONF_DIR
...
### ApplicationManager
MANAGER_INSTALL_IP=$HOSTNAME
MANAGER_PORT=9101

### EngineManager
ENGINECONNMANAGER_INSTALL_IP=$HOSTNAME
ENGINECONNMANAGER_PORT=9102



### EnginePluginServer
ENGINECONN_PLUGIN_SERVER_INSTALL_IP=$HOSTNAME
ENGINECONN_PLUGIN_SERVER_PORT=9103

### LinkisEntrance
ENTRANCE_INSTALL_IP=$HOSTNAME
ENTRANCE_PORT=9104

###  publicservice
PUBLICSERVICE_INSTALL_IP=$HOSTNAME
PUBLICSERVICE_PORT=9105

### cs
CS_INSTALL_IP=$HOSTNAME
CS_PORT=9108
